...
var lineDrawing = anime({
  ...
  duration: 4000,
  begin: function(anim) {
    [leafOne, leafTwo, leafS1, stickLine, rose1, rose2, rose3, rose4].forEach(el => {
  ...
  complete: function(anim) {
    // Colores más vivos
    leafOne.setAttribute("fill", "#28A745"); 
    leafTwo.setAttribute("fill", "#28A745");
    leafS1.setAttribute("fill", "#28A745");
    stickLine.setAttribute("fill", "#145A32"); 
    
    rose1.setAttribute("fill", "#FF3B3F"); 
    rose2.setAttribute("fill", "#D90429"); 
    rose3.setAttribute("fill", "#FF3B3F");
    rose4.setAttribute("fill", "#D90429");
...
function createFallingPetal() {
  ...
  petal.setAttribute("d", "M10 0 C20 10, 20 30, 10 40 C0 30, 0 10, 10 0");
  petal.setAttribute("fill", "#F37D79");
  petal.setAttribute("stroke", "none");
  ...
  anime({
    targets: petal,
    translateX: [startX, startX + Math.random() * 50 - 25],
    translateY: [startY, window.innerHeight],
...
const crtLoveTl = () => {
  ...
  new mojs.Shape({
    ...
    x: -60,
    y: 300,
    scale: { 0: 0.8, easing: easingHeart },
    duration: 500 }).
  then({
    x: { to: -62, easing },
    scale: { to: 0.5, easing },
